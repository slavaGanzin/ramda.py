...
def dicts_equal(dict1, dict2):
    return dict1 == dict2 or (is_dict(dict1) and is_dict(dict2) and all(map(lambda x, y: x == y, dict1.keys(), dict2.keys())) and all(map(dicts_equal, dict1.values(), dict2.values())))
